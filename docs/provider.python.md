...
Represents a {@link https://registry.terraform.io/providers/hashicorp/null/3.3.2/docs null}.

#### Initializers <a name="Initializers" id="@cdktn/provider-null.provider.NullProvider.Initializer"></a>

```python
from cdktn_provider_null import provider
...
| <code><a href="#@cdktn/provider-null.provider.NullProvider.Initializer.parameter.id">id</a></code> | <code>str</code> | The scoped construct ID. |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.Initializer.parameter.alias">alias</a></code> | <code>str</code> | Alias name. |
...
##### `alias`<sup>Optional</sup> <a name="alias" id="@cdktn/provider-null.provider.NullProvider.Initializer.parameter.alias"></a>
...
| **Name** | **Description** |
| --- | --- |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.toString">to_string</a></code> | Returns a string representation of this construct. |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.with">with</a></code> | Applies one or more mixins to this construct. |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.addOverride">add_override</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.overrideLogicalId">override_logical_id</a></code> | Overrides the auto-generated logical ID with a specific ID. |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.resetOverrideLogicalId">reset_override_logical_id</a></code> | Resets a previously passed logical Id to use the auto-generated logical id again. |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.toMetadata">to_metadata</a></code> | *No description.* |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.toTerraform">to_terraform</a></code> | Adds this resource to the terraform JSON output. |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.resetAlias">reset_alias</a></code> | *No description.* |

---

##### `to_string` <a name="to_string" id="@cdktn/provider-null.provider.NullProvider.toString"></a>
...
##### `add_override` <a name="add_override" id="@cdktn/provider-null.provider.NullProvider.addOverride"></a>
...
##### `override_logical_id` <a name="override_logical_id" id="@cdktn/provider-null.provider.NullProvider.overrideLogicalId"></a>
...
###### `new_logical_id`<sup>Required</sup> <a name="new_logical_id" id="@cdktn/provider-null.provider.NullProvider.overrideLogicalId.parameter.newLogicalId"></a>
...
##### `reset_override_logical_id` <a name="reset_override_logical_id" id="@cdktn/provider-null.provider.NullProvider.resetOverrideLogicalId"></a>
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktn/provider-null.provider.NullProvider.toHclTerraform"></a>

```python
def to_hcl_terraform() -> typing.Any
```

##### `to_metadata` <a name="to_metadata" id="@cdktn/provider-null.provider.NullProvider.toMetadata"></a>

```python
def to_metadata() -> typing.Any
```

##### `to_terraform` <a name="to_terraform" id="@cdktn/provider-null.provider.NullProvider.toTerraform"></a>
...
##### `reset_alias` <a name="reset_alias" id="@cdktn/provider-null.provider.NullProvider.resetAlias"></a>
...
##### `is_construct` <a name="is_construct" id="@cdktn/provider-null.provider.NullProvider.isConstruct"></a>
...
##### `is_terraform_element` <a name="is_terraform_element" id="@cdktn/provider-null.provider.NullProvider.isTerraformElement"></a>
...
##### `is_terraform_provider` <a name="is_terraform_provider" id="@cdktn/provider-null.provider.NullProvider.isTerraformProvider"></a>
...
##### `generate_config_for_import` <a name="generate_config_for_import" id="@cdktn/provider-null.provider.NullProvider.generateConfigForImport"></a>
...
###### `import_to_id`<sup>Required</sup> <a name="import_to_id" id="@cdktn/provider-null.provider.NullProvider.generateConfigForImport.parameter.importToId"></a>
...
###### `import_from_id`<sup>Required</sup> <a name="import_from_id" id="@cdktn/provider-null.provider.NullProvider.generateConfigForImport.parameter.importFromId"></a>

- *Type:* str

The id of the existing NullProvider that should be imported.

Refer to the {@link https://registry.terraform.io/providers/hashicorp/null/3.3.2/docs#import import section} in the documentation of this resource for the id to use
...
##### `cdktf_stack`<sup>Required</sup> <a name="cdktf_stack" id="@cdktn/provider-null.provider.NullProvider.property.cdktfStack"></a>
...
##### `friendly_unique_id`<sup>Required</sup> <a name="friendly_unique_id" id="@cdktn/provider-null.provider.NullProvider.property.friendlyUniqueId"></a>
...
##### `meta_attributes`<sup>Required</sup> <a name="meta_attributes" id="@cdktn/provider-null.provider.NullProvider.property.metaAttributes"></a>
...
##### `terraform_resource_type`<sup>Required</sup> <a name="terraform_resource_type" id="@cdktn/provider-null.provider.NullProvider.property.terraformResourceType"></a>
...
##### `terraform_generator_metadata`<sup>Optional</sup> <a name="terraform_generator_metadata" id="@cdktn/provider-null.provider.NullProvider.property.terraformGeneratorMetadata"></a>
...
##### `terraform_provider_source`<sup>Optional</sup> <a name="terraform_provider_source" id="@cdktn/provider-null.provider.NullProvider.property.terraformProviderSource"></a>
...
##### `alias_input`<sup>Optional</sup> <a name="alias_input" id="@cdktn/provider-null.provider.NullProvider.property.aliasInput"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-null.provider.NullProvider.property.tfResourceType">tfResourceType</a></code> | <code>str</code> | *No description.* |
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-null.provider.NullProviderConfig.property.alias">alias</a></code> | <code>str</code> | Alias name. |
