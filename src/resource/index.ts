...
// https://registry.terraform.io/providers/hashicorp/null/3.3.0/docs/resources/resource
...
export class Resource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Resource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/null/3.3.0/docs/resources/resource#import import section} in the documentation of this resource for the id to use
