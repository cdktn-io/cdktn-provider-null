...
// https://registry.terraform.io/providers/hashicorp/null/3.3.2/docs/data-sources/data_source
...
export class DataNullDataSource extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNullDataSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/null/3.3.2/docs/data-sources/data_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/null/3.3.2/docs/data-sources/data_source null_data_source} Data Source
  *
  * @param scope The scope in which to define this construct
